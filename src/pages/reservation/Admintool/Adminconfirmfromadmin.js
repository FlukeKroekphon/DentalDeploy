...
const Adminconfirmfromadmin = () => {
    ...
    async function handelApprove(id) {
        ...
        await axios.put(
            'http://10.6.21.41:8080/details/updateDetails/' + id,
            toolStatus
        )
            ...
            <Navbar collapseOnSelect expand="lg" style={{ backgroundColor: 'white' }}>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav style={{ marginLeft: '80px' }} className="mr-auto">
                        <Nav.Link style={{ color: '#424242', fontSize: '23px' }} as={Link} to="/Adminconfirm">อุปกรณ์รอการยืนยัน</Nav.Link>
                        <Nav.Link style={{ color: '#0080ff', fontSize: '23px' }} as={Link} to="/Adminconfirmfromadmin">อุปกรณ์ที่ยืนยันเเล้ว</Nav.Link>
